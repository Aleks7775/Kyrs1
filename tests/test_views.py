...
@pytest.fixture()
def transaction():
    return {{'Дата операции': '02.01.2019 17:08:12', 'Номер карты': '*7197',
             'Сумма операции с округлением': 316.0, 'Категория': 'Переводы', 'Описание': 'Линзомат ТЦ Юность'},
            {'Дата операции': '02.01.2018 17:08:12', 'Номер карты': '*6197',
             'Сумма операции с округлением': 415.0, 'Категория': 'Красота', 'Описание': 'OOO Balid'},
            {'Дата операции': '02.01.2019 17:08:12', 'Номер карты': '*4197',
             'Сумма операции с округлением': 854.0, ' Категория': 'Топливо',
             'Описание': 'Pskov AZS 12 K2'},
            {'Дата операции': '02.01.2018 17:08:12', 'Номер карты': '*5197',
             'Сумма операции с округлением': 2500.0, 'Категория': 'Супермаркеты', 'Описание': 'Магнит'},
            {'Дата операции': '02.01.2020 17:08:12', 'Номер карты': '*5197',
             'Сумма операции с округлением': 4000.0, 'Категория': 'Топливо',
             'Описание': 'Pskov AZS 12 K2'},
            {'Дата операции': '02.01.2020 17:08:12', 'Номер карты': '*5197',
             'Сумма операции с округлением': 3500.0, 'Категория': 'Супермаркеты', 'Описание': 'Лента'}}
...
def test_date_entry(transaction):
    ...
    assert date_entry(transaction, data_time="05.01.2019 10:10:10") == [
        {'Дата операции': '02.01.2019 17:08:12', 'Номер карты': '*7197',
         'Сумма операции с округлением': 316.0, 'Категория': 'Переводы', 'Описание': 'Линзомат ТЦ Юность'},
        {'Дата операции': '02.01.2019 17:08:12', 'Номер карты': '*4197',
         'Сумма операции с округлением': 854.0, 'Категория': 'Топливо', 'Описание': 'Pskov AZS 12 K2'}]
...
def test_top_transaction(transaction):
    ...
    assert top_transaction(transaction) == {{'amount': 4000.0,
                                             'category': 'Топливо', 'date': '02.01.2020 17:08:12',
                                             'description': 'Pskov AZS 12 K2'},
                                            {'amount': 3500.0, 'category': 'Супермаркеты',
                                             'date': '02.01.2020 17:08:12', 'description': 'Лента'},
                                            {'amount': 2500.0, 'category': 'Супермаркеты',
                                             'date': '02.01.2018 17:08:12', 'description': 'Магнит'},
                                            {'amount': 854.0, 'category': 'Топливо', 'date': '02.01.2019 17:08:12',
                                             'description': 'Pskov AZS 12 K2'},
                                            {'amount': 415.0, 'category': 'Красота', 'date': '02.01.2018 17:08:12',
